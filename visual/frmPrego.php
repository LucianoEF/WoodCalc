       ...
       <?php  include "../core/verifica_session.php";
        ...
        echo '<div class="row">
            <div class="col text-center">
                <!-- Título -->
                <h4 class="text-center"><img src="../img/nails.png" width="50px" height="50px">Cadastrar Prego</h4>
                <br/>
                <br/>
        ...
        <!--frmPrego -->
        <form name="frmPrego" action="../classes/operacoesPrego.php" method="post">
            <div class="row">
                <div class="col"> 
                    ...
                    <select style="margin-left: 20px;" class="form-control" id="categoria" name="categoria" required>
                        <option selected value="Prego">Prego</option>
                    </select>
                </div>
                <div class="col"> 
                    <label for="tipo">Tipo de Prego<font color="red">*</font></label>
        ...
        if ($operacao == 'alterar') {
            ...
            $sql = "SELECT *  FROM prego_tbl WHERE id=?";
            $q = $pdo->prepare($sql);
            $q->execute(array($prego));

            echo '<h4 class="text-center"><img src="../img/refresh.png" width="35px" height="35px">Alterar Prego</h4>
            <br/>
        ...
        foreach ($q as $row){
            ...
            <div class="row">
                <div class="col text-center">
                    ...
                    <input type="hidden" id="user" name="pregoData" value="'.$prego.'">

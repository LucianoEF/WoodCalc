       ...
       <?php  include "../core/verifica_session.php";
        ...
        <div class="row">
            <div class="col text-center">
                <!-- Título -->
                <h2 class="text-center"><img src="../img/project.png" width="50px" height="50px"> Novo Projeto - Modelo II <img src="../img/modelo2.png" width="150px" height="75px"></h2>
                <br/>
                <br/>
        ...
        <form name="dadosCadastrais" action="../classes/resultadoModeloI.php" method="post">
            <div class="row text-center">
                <div class="col"> 
                    <label style="margin-left: 5px;" for="name">Nome do Projeto</label>
                    <input style="margin-left: 5px;" type="text" class="form-control" id="name" name="name">
                </div>
                <div class="col"> 
                ...
                <div class="col"> 
                    ...
                    <select class="form-control" id="tipoproj" name="tipoproj" required>
        ...
        <div class="row text-center">    
            <div class="col"> 
                ...
                <select style="margin-left: 5px;" class="form-control" id="tipomadeira" name="tipomadeira" onchange="kmod()" required>
                        <option>Selecione..</option>
                        <option class="form-control" id="macica" name="macica" value="macica" acao="ymmacica" selected>Maciça</option>
                        <option class="form-control" id="lameladacolada" name="lameladacolada" value="lameladacolada" acao="ymlameladacolada">Lamelada Colada</option>
                        <option class="form-control" id="lvl" name="lvl" value="lvl" acao="ymlvl">LVL</option>
                        <option class="form-control" id="contraplacado" name="contraplacado" value="contraplacado" acao="ymcontraplacado">Contraplacado</option>
                        <option class="form-control" id="osb" name="osb" value="osb" acao="ymosb">Osb</option>
                </select>
            </div>
            <div class="col">
                <label>Espécie da madeira <font color="red">*</font></label>
                <select id="espmadeira" class="form-control" name="espmadeira" required>
                    <option>Eucalypto-grandis</option>
                    <option>Eucalyptus europhylla</option>
                </select>
            </div>
            <div class="col">
        ...
        <div class="row text-center">
            <div class="col"> 
                ...
                <select style="margin-left: 5px;" onchange="kmod()" class="form-control" id="classeduracao" name="classeduracao" required>
                        ...
                        <option value="longoprazo">Longo Prazo</option>
                        <option value="medioprazo">Médio Prazo</option>
                        <option value="curtoprazo">Curto Prazo</option>
            ...
            <div class="col"> 
                ...
                <select class="form-control" onchange="kmod()" id="classeservi" name="classeserv" required>
                        <option>Selecione..</option>
                        <option value="classe1" selected>Classe 1</option>

...
<style type="text/css">
    ...
    <body>
       <?php   include "../core/verifica_session.php";
        ...
        <div class="p-3 mb-2 bg-dark text-white"><h3 class="text-center">Relatórios</h3></div>
        
        <form class="form-inline">
            <input style="margin-left: 20px;" class="form-control mr-sm-2" type="search" placeholder="Pesquisar.." aria-label="Search">

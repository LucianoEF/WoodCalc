...
<style type="text/css">
    ...
    <body>
       <?php  include "../core/verifica_session.php";
            ...
            include '../core/Database.php';
                ...
                $hip = sqrt(pow($altpendural, 2) + pow(($largura/2), 5));
                $hip = round($hip, 5);
                //echo $hip. "<br>";
                ...
                //Tensão Normal Máxmimas
                    ...
                    $mymax = round(($fx * (pow($disttesoura, 2))/8), 5);
                    //echo $mymax. "<br>";
    ...
    <?php
                    ...
                    $tmxmax = round($mxmax / (($baseterca * (pow($altterca, 2))) / 6), 5);
    ...
    <?php
                    ...
                    $tmymax = round($mymax / (($altterca * (pow($baseterca, 2))) / 6), 5);
    ...
    <?php
                ...
                //Verificação quanto à flexão Oblíqua
                    //Condição I
                    $cond1 = round(( (($tmxmax / 10000) / ($fcod * 10)) + (0.7 * (($tmymax / 10000) / ($fcod * 10)))), 5);
                    if ($cond1 < 1){
    ...
    <?php
                    ...
                    //Condição II
                    $cond2 = round(( (0.7 * (($tmxmax / 10000) / ($fcod * 10))) + (($tmymax / 10000) / ($fcod * 10))), 5);
                    if ($cond2 < 1){
    ...
    <?php
                ...
                $pbeiral = round((($p/2) + (($p/$distterca) * 0.8)), 5);
                //echo $pbeiral. "<br>";

                //Cálculo da reação de apoio.
                //Analisado por simetria.
                $rapoio = round(($pbeiral + (2.5 * $p)), 5);
                //echo $rapoio. "<br>";

                //cálculo de hipotenusa da escora
                $hipes = sqrt(pow(($altpendural * (2 / 3)), 2) + pow(($largura/6), 5));
                $hipes = round($hipes, 5);
                //echo $hipes. "<br>";

                //cálculo de senx
                $senx = round((($altpendural * (2 / 3)) / $hipes), 5);
                //echo $senx. "<br>";

                //cálculo de cosx
                $cosx = round((($largura/6) / $hipes), 5);
                //echo $cosx. "<br>";
                ...
                //Método dos Nós.
                    //Nó A.
                        //Barra 'AB'.
                        $ab = round((($pbeiral - $rapoio) / $sen0), 5);
                    ...
                    //echo $cosy. "<br>";
                        ...
                        $cos02 = round((((2* ($hip/3)* ($hip/3)) - ($altpendural * (2 / 3))) / (2 * ($hip/3)* ($hip/3))), 5);
                        //echo $cos02. "<br>";

                        $bd = round(($ab + ($p * $cosy) - ($be * $cos02)), 5);
                    ...
                    //Nó D.
                        //Barra 'DF'.
                        $df = round(((($bd * $seny) + (((($bd * $cosy) + $ed + $p) / $senx) * $cosx)) / ($cos0 + (($sen0 * $cosx) / $senx))), 5);
                            //Imprimi Compressão caso o resultado 'eg' seja negativo.
                            if ($df < 1){
    ...
    <?php
                ...
                <?php
                    ...
                    $tntbs = round(($nbs / ($basebs * $altbs)), 5);
            ...
            <div class="row text-center">
                <?php
                    ...
                    $condbs = round(((-$tntbs / 10000) / ($fcod * 10)), 5);
            ...
            <br/><?php
                ...
                //Verificação quanto à esbeltez
                    ...
                    $l0x = sqrt(pow(($altpendural / 3), 2) + pow(($largura/6), 5));
                    //cálculo de lambdax.
                    $lambdax = round((($l0x * sqrt(12)) / $altbs), 5);
                    //echo $lambdax. "<br>";
                    //cálculo de lambda,relx    
                    $lambdarelx = round(($lambdax / 3.14) * sqrt(($fc0k / $ecof)), 5);
                    //echo $lambdarelx. "<br>";
                    //cálculo de kx    
                    $kx = round((0.5 * (1 + (0.2* ($lambdarelx - 0.3) + pow($lambdarelx, 2)))), 5);
                    //echo $kx. "<br>";
                    //cálculo de kcx    
                    $kcx = round((1 / ($kx + sqrt(pow($kx, 2) - pow($lambdarelx, 2)))), 5);
                    //echo $kcx. " valor a guardar<br> ";

                    //cálculo de distancia l0y.
                    $l0y = sqrt(pow(($altpendural / 3), 2) + pow(($largura/6), 5));
                    //cálculo de lambdaybs.
                    $lambdaybs = round((($l0y * sqrt(12)) / $basebs), 3);
                    //echo $lambdaybs. "<br>";
                    //cálculo de lambda,rely    
                    $lambdarelybs = round(($lambdaybs / 3.14) * sqrt(($fc0k / $ecof)), 5);
                    //echo $lambdarelybs. "<br>";
                    //cálculo de ky    
                    $ky = round((0.5 * (1 + (0.2* ($lambdarelybs - 0.3) + pow($lambdarelybs, 2)))), 5);
                    //echo $ky. "<br>";
                    //cálculo de kcy    
                    $kcy = round((1 / ($ky + sqrt(pow($ky, 2) - pow($lambdarelybs, 2)))), 5);
                    //echo $kcy. "<br>";

            ?><div class="row text-center"><?php
                    //Cálculo da Tensão Normal no Banzo Superior com os coeficientes kcx e kcy.
                        $condbskcx = round(((-$tntbs / 10000) / ($kcx * $fcod * 10)), 5);
                        //Imprimi Atende caso o resultado 'tntbs' seja menor do que 1, atendendo as exigencias da norma EuroCode5.
                        if ($condbskcx < 1){
                            ?>
                <div class="col">
                ...
                <div class="col">
                        ...
                        $condbskcy = round(((-$tntbs / 10000) / ($kcy * $fcod * 10)), 5);
                        //Imprimi Atende caso o resultado 'tntbs' seja menor do que 1, atendendo as exigencias da norma EuroCode5.
                        if ($condbskcy < 1){
                            ?>
                <div class="col">
            ...
            <?php
                ...
                $tntbi = round(($nbi / ($basebi * $altbi)), 5);
            ...
            <?php
                ...
                //Verificação quanto à flexão
                $condbi = round((($tntbi / 10000) / ($fcod * 10)), 5);
        ...
        <?php
                ...
                $tntes = round(($nes / ($basees * $altes)), 5);
        ...
        <?php
                ...
                //Verificação quanto à flexão
                $condes = round(((-$tntes / 10000) / ($fcod * 10)), 5);
        ...
        <?php
                ...
                //Verificação quanto à esbeltez
                    ...
                    $l0esx = round(sqrt(pow((($altpendural * 2) / 3), 2) + pow($largura/6, 2)), 5);
                    //echo $l0esx. "<br>";
                    //cálculo de lambdaesx.
                    $lambdaesx = round((($l0esx * sqrt(12)) / $altes), 5);
                    //echo $lambdaesx. "<br>";
                    //cálculo de lambdaesrelx    
                    $lambdaesrelx = round(($lambdaesx / 3.14) * sqrt(($fc0k / $ecof)), 5);
                    //echo $lambdaesrelx. "<br>";
                    //cálculo de kxes    
                    $kxes = round((0.5 * (1 + (0.2* ($lambdaesrelx - 0.3) + pow($lambdaesrelx, 2)))), 5);
                    //echo $kxes. "<br>";
                    //cálculo de kcxes    
                    $kcxes = round((1 / ($kxes + sqrt(pow($kxes, 2) - pow($lambdaesrelx, 2)))), 5);
                    //echo $kcxes;

                    //cálculo de distancia l0esy.
                    $l0esy = $l0esx;
                    //cálculo de lambdaesy.
                    $lambdaesy = round((($l0esy * sqrt(12)) / $basees), 5);
                    //echo $lambdaesy. "<br>";
                    //cálculo de lambdaesrely    
                    $lambdaesrely = round(($lambdaesy / 3.14) * sqrt(($fc0k / $ecof)), 5);
                    //echo $lambdaesrely. "<br>";
                    //cálculo de kyes    
                    $kyes = round((0.5 * (1 + (0.2* ($lambdaesrely - 0.3) + pow($lambdaesrely, 2)))), 5);
                    //echo $kyes. "<br>";
                    //cálculo de kcyes    
                    $kcyes = round((1 / ($kyes + sqrt(pow($kyes, 2) - pow($lambdaesrely, 2)))), 5);
                    //echo $kcyes. "<br>";

                    //Cálculo da Tensão Normal no Escoras com os coeficientes kcxes e kcyes.
                        $condeskcx = round(((-$tntes / 10000) / ($kcxes * $fcod * 10)), 5);
                        //Imprimi Atende caso o resultado 'tntes' seja menor do que 1, atendendo as exigencias da norma EuroCode5.
        ?>
            </div>
            <br/>
